        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-4 feature-box"> {/*lg = desktoop md = tablet sm = celular || 4 pois vou dividir a tela em 3 partes */}
                    <i class="icon fas fa-heart fa-5x"></i> {/*icone de coração fa-5x escolhemos quantas vezes quero maior*/}
                ...
                <div className="col-lg-4 feature-box"> {/*2ª coluna */}
                    <i class="icon fas fa-globe-americas fa-5x"></i> {/*logo de globo*/}
                ...
                <div className="col-lg-4 feature-box"> {/*2ª coluna */}
                    <i class="icon fas fa-columns fa-5x"></i> {/*logo de colunas*/}
