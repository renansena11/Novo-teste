            ...
            <div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                        <h2>Excelente ferramenta para acompanhamento da minha usina solar.</h2>
                ...
                <div className="carousel-item" data-bs-interval="1500">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                    <h2>Ótimo recurso para acompanhar meus processos indústriais em qualquer lugar ou plataforma.</h2>
                ...
                <div className="carousel-caption d-none d-md-block">
                    <h2>Perfeito para a organização de minha casa, onde consigo realizar e acompanhar minha automação residencial em apenas um lugar.</h2>
